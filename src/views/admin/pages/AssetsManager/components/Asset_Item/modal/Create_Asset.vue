        ...
        <div class="bg-white p-5 rounded-3" style="width:1000px">
            <div class="d-flex mb-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-primary mb-1">Tạo hạng mục công trình</h6>
                        <p class="mb-0 text-muted" style="font-size:12px">Tạo hạng mục công trình với dữ liệu đi kèm</p>
                    </div>
                </div>
    ...
    methods : {
        async CreateAsset(){            
            try {
                ...
                axios.post(apiProject + '/asset-item/create',params,config)
                .then(async res => {
                    await this.$refs.FileManager.UpdateLegal({id:res.data.data.id,type:'TYPE_ASSET_ITEMS'})
                    this.Display(false)
