            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Nhập tên pháp lý đất ..." v-model="data.asset_repair_content">
                    </div>
                    <div class="mb-3">
...
export default {
    components: {
        VueDatePicker,...Icons,FileManager
    },
    data(){
        return {
            id : null,
    ...
    methods : {
        ...
        async Display(value,data){
            ...
            if(value){
                this.id = await data
                this.$refs.FileManager._Init({id:data,type:'TYPE_ASSET_REPAIR'});
