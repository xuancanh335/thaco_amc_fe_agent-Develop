        ...
        <div class="bg-white p-5 rounded-3" style="width:1000px">
            <div class="d-flex mb-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-primary mb-1">Tạo hiện trạng tài sản</h6>
                        <p class="mb-0 text-muted" style="font-size:12px">Tạo hiện trạng tài sản với dữ liệu đi kèm</p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Nhập tên hiện trạng tài sản ..." v-model="data.asset_status_content">
                    </div>
                    <div class="mb-3">
    ...
    methods : {
        async CreateAsset(){            
            try {
                ...
                axios.post(apiProject + '/asset-status/create',params,config)
                .then(async res => {
                    await this.$refs.FileManager.UpdateLegal({id:res.data.data.id,type:'TYPE_ASSET_STATUS'})
                    this.Display(false)
