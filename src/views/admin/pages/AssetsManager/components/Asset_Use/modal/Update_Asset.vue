        ...
        <div class="bg-white p-5 rounded-3" style="width:1000px">
            <div class="d-flex mb-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-primary mb-1">Cập nhật mục đích sử dụng</h6>
                        <p class="mb-0 text-muted" style="font-size:12px">Cập nhật mục đích sử dụng với dữ liệu đi kèm</p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Nhập tên mục đích ..." v-model="data.asset_use_content">
                    </div>
                    <div class="mb-3">
    ...
    methods : {
        async UpdateLegal(){            
            try {
                ...
                axios.post(apiProject + '/asset-use/update',params,config)
                .then(async res => {
                    this.Display(false)
        ...
        async GetDataAsset(){            
            try {
                ...
                const config = {headers: {Authorization: `Bearer ${authorize.token}`}};
                axios.post(apiProject + '/asset-use/get-by-id',params,config)
                .then(async res => {
        ...
        async Display(value,data){
            ...
            if(value){
                this.id = await data
                this.$refs.FileManager._Init({id:data,type:'TYPE_ASSET_USE'});
