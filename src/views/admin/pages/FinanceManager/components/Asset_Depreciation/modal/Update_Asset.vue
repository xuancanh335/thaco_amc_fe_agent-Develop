        ...
        <div class="bg-white p-5 rounded-3" style="width:500px">
            ...
            <div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập giá trị khấu hao ..." v-model="data.asset_depreciation_value" v-number="number">
                </div>
                <div class="mb-3">
    ...
    methods : {
        async UpdateLegal(){            
            try {
                ...
                axios.post(apiProject + '/asset-depreciation/update',params,config)
                .then(async res => {
                    this.Display(false)
        ...
        async GetDataAsset(){            
            try {
                ...
                const config = {headers: {Authorization: `Bearer ${authorize.token}`}};
                axios.post(apiProject + '/asset-depreciation/get-by-id',params,config)
                .then(async res => {
