        ...
        <div class="bg-white p-5 rounded-3" style="width:700px">
            <div class="d-flex mb-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-primary mb-1">Tạo tài chính tài sản</h6>
                        <p class="mb-0 text-muted" style="font-size:12px">Tạo tài chính tài sản với dữ liệu đi kèm</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập tên tài chính ..." v-model="data.asset_finance_code">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập giá trị khấu hao ..." v-model="data.depreciation_value" v-number="number">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <VueDatePicker class="custom-datepicker" v-model="data.mortgage_date" placeholder="Chọn ngày bắt đầu" auto-apply :format="'dd/MM/yyyy'"  :enable-time-picker="false"></VueDatePicker>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label class="form-label">Giá trị HĐ thế chấp (<span class="text-danger">*</span>)</label>
                            <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập giá trị HĐ thế chấp ..." v-model="data.mortgage_value" v-number="number">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label class="form-label">Số lượng tài sản thế chấp (<span class="text-danger">*</span>)</label>
                            <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập số lượng ..." v-model="data.asset_mortgage_quantity" v-number="number">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label class="form-label">Số HĐ tín dụng (<span class="text-danger">*</span>)</label>
                            <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập số HĐ tín dụng ..." v-model="data.number_credit">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label class="form-label">Đối tượng thế chấp (<span class="text-danger">*</span>)</label>
                            <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập đối tượng ..." v-model="data.mortgage_object">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3">
    ...
    methods : {
        ...
        async CreateAsset(){            
            try {
                ...
                axios.post(apiProject + '/asset-finance/create',params,config)
                .then(async res => {
                    this.Display(false)
