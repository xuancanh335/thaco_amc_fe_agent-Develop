        ...
        <div class="bg-white p-5 rounded-3" style="width:500px">
            <div class="d-flex mb-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-primary mb-1">Cập nhật sửa chữa tài sản</h6>
                        <p class="mb-0 text-muted" style="font-size:12px">Cập nhật sửa chữa tài sản với dữ liệu đi kèm</p>
                    </div>
                </div>
            ...
            <div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập tên pháp lý đất ..." v-model="data.asset_repair_content">
                </div>
                <div class="mb-3">
                    <label class="form-label">Giá trị sửa chữa (<span class="text-danger">*</span>)</label>
                    <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập giá trị sửa chữa ..." v-model="data.asset_repair_value" v-number="number">
                </div>
                <div class="mb-3">
    ...
    methods : {
        async UpdateLegal(){            
            try {
                ...
                params.asset_repair_value = this.FormatNumberic(params.asset_repair_value)
                const config = {headers: {Authorization: `Bearer ${authorize.token}`}};
                axios.post(apiProject + '/asset-repair/update',params,config)
                .then(async res => {
                    this.Display(false)
        ...
        async GetDataAsset(){            
            try {
                ...
                const config = {headers: {Authorization: `Bearer ${authorize.token}`}};
                axios.post(apiProject + '/asset-repair/get-by-id',params,config)
                .then(async res => {
