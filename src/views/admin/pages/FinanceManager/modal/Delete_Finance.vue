<template lang="">
    ...
    <div class="modal fade scale-in-center" id="Modal_DeleteFinance" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-body p-4">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button class="btn btn-danger" @click="DeleteLegal">Xóa dữ liệu</button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    mounted(){
        modal = new bootstrap.Modal('#Modal_DeleteFinance');
    },
    methods : {
        async _Init(value){
        ...
        async DeleteLegal(){            
            try {
                ...
                axios.post(PATH_API_DATA + '/project-finance/delete',params,config)
                .then(async res => {
                    modal.hide()
