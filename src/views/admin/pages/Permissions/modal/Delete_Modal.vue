<template lang="">
    <div class="modal fade scale-in-center" id="Delete_Modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body p-4">
                    <div class="d-flex gap-3 mb-4">
                        ...
                        <div class="flex-grow-1">
                            <h5>Xóa quyền nguời dùng</h5>
                            <p class="mb-0 text-muted">Bạn sẽ mất tất cả các dữ liệu liên quan đến quyền, bạn có chắc chắn muốn xóa !</p>
                        </div>
                    </div>
...
export default {
    ...
    mounted(){modal = new bootstrap.Modal('#Delete_Modal');},
    methods : {
        async _Init(value){
        ...
        async DeleteData(){
            try {
                ...
                await axios.post(PATH_API_USER + '/profile/delete',params,config)
                .then(async res => {
                ...
                .catch(err => {
                    ShowToast({status_code : 200, message : 'Xóa dữ liệu thất bại'});
                })
            } catch (error) {
                ShowToast({status_code : 200, message : 'Xóa dữ liệu thất bại'});
            }
