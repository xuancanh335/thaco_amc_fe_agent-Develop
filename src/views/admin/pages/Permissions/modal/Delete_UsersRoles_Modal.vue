<template lang="">
    <div class="modal fade scale-in-center" id="Delete_UsersRoles_Modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
export default {
    ...
    mounted(){modal = new bootstrap.Modal('#Delete_UsersRoles_Modal');},
    methods : {
        async _Init(value){
        ...
        async DeleteData(){
            try {
                ...
                await axios.post(PATH_API_USER + '/profile/delete-user-in-profile',params,config)
                .then(async res => {
