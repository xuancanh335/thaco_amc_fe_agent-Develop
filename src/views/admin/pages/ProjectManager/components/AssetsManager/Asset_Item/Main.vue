<template lang="">
    ...
    <div class="accordion" :id="slug+'Parent'">
        <div class="accordion-item mb-3 rounded-0 border-bottom position-relative">
            ...
            v-if="$CheckPermission('Asset_Item','is_allow_create')"
            >
                <button
                v-if="!view"
                ...
                <div class="w-100 border-0 p-3" type="button" data-bs-toggle="collapse" :data-bs-target="'#'+slug" aria-expanded="true">
                    <div class="d-flex">
                        <div class="d-flex align-items-center gap-3 flex-grow-1">
                            ...
                            <div>
                                <h6 class="mb-0 fw-bold text-primary mb-1">Hạng mục công trình</h6>
                                <p class="mb-0 text-muted" style="font-size:12px">Danh sách hạng mục công trình</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div :id="slug" class="accordion-collapse collapse " :data-bs-parent="'#'+slug+'Parent'">
                <div class="accordion-body border-top">
                    ...
                    v-if="$CheckPermission('Asset_Item','is_allow_access')"
                    >
                        <table v-if="data && data.length != 0" class="table table-sm table-striped table-fixed align-middle">
                            ...
                            <tbody>
                                <tr  v-for="(item, index) in data" :key="index">
                                    ...
                                    <td class="fw-bold text-back-50 text-capitalize">{{item.asset_items_content}}</td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1 justify-content-end">
                                            <div v-if="$CheckPermission('Asset_Item','is_allow_edit')">
                                            ...
                                            <div v-if="$CheckPermission('Asset_Item','is_allow_delete')">
