        ...
        <div class="bg-white p-4 rounded-3" style="width:600px; max-height:650px; overflow:hidden">
            ...
            <div class="d-flex mb-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-primary mb-1">Danh sách tập tin hiện trạng tài sản</h6>
                        <p class="mb-0 text-muted" style="font-size:12px">Danh sách tập tin hiện trạng tài sản với dữ liệu đi kèm</p>
                    </div>
                </div>
...
export default {
    ...
    methods : {
        ...
        async UpdateLegal(){           
            ...
            data.append('object_type', 'TYPE_ASSET_STATUS');
