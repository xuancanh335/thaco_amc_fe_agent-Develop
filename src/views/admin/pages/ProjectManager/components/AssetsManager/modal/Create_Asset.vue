        ...
        <div class="bg-white p-5 rounded-3" style="width:700px">
            <div class="d-flex mb-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-primary mb-1">Tạo tài sản mới</h6>
            ...
            <div>
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label class="form-label mb-2">Ngày tạo tài sản (<span class="text-danger">*</span>)</label>
    ...
    methods : {
        async CreateAsset(){ 
            try {
                ...
                axios.post(PATH_API_DATA + '/asset/create',params,config)
                .then(async res => {
                    this.Display(false)
...
<style lang="scss">
    .custom-selectbox.asset .el-input .el-input__wrapper{
