        ...
        <div class="bg-white p-5 rounded-3" style="width:700px">
            <div class="d-flex mb-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-primary mb-1">Cập nhật tài chính dự án</h6>
                        <p class="mb-0 text-muted" style="font-size:12px">Cập nhật tài chính dự án với dữ liệu đi kèm</p>
                    </div>
                </div>
            ...
            <div>
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label class="form-label mb-2">Đối tượng thế chấp (<span class="text-danger">*</span>)</label>
