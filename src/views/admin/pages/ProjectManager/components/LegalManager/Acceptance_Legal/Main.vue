                    ...
                    <div class="d-flex mb-3">
                        <div class="d-flex align-items-center gap-3 flex-grow-1">
                            <div class="bg-gradient-blue text-white rounded-3 p-2 bg-opacity-25 ">
                                <IconClipboardText :size="22" class="d-flex" stroke-width="2" />
                            </div>
                            <div class="d-flex w-100 justify-content-between align-items-center">
                                <div>
                                    <h6 class="mb-0 fw-bold mb-1 text-gradient-blue">Pháp lý nghiệm thu và sở hữu công trình</h6>
                                    <p class="mb-0 text-muted" style="font-size:12px">Danh sách pháp lý nghiệm thu và sở hữu công trình</p>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex flex-column gap-2">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                                <input type="text" class="form-control form-control-sm" placeholder="Tên công trình ..." :readonly="view" :disabled="view" v-model="data.acceptance_construction_name">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-5">
                                            ...
                                            <div class="col-lg-7">
                                                <input type="text" class="form-control form-control-sm" placeholder="Diện tích xây dựng ..." :readonly="view" :disabled="view" v-model="data.acceptance_building_area">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-5">
                                                <div class="d-flex align-items-center h-100">
                                                    <IconFileInfo :size="24" class="d-flex text-muted bg-dark bg-opacity-10 p-1 rounded-2" stroke-width="2" />
                                                    <span class="ms-2">Diện tích sàn xây dựng hoặc công suất :</span>
                                                </div>
                                            </div>
                                            <div class="col-lg-7">
                                                <input type="text" class="form-control form-control-sm" placeholder="Diện tích sàn xây dựng hoặc công suất..." :readonly="view" :disabled="view" v-model="data.acceptance_total_area">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-5">
                                                <div class="d-flex align-items-center h-100">
                                                    <IconKey :size="24" class="d-flex text-muted bg-dark bg-opacity-10 p-1 rounded-2" stroke-width="2" />
                                                    <span class="ms-2">Số tầng :</span>
                                                </div>
                                            </div>
                                            <div class="col-lg-7">
                                                <input type="text" class="form-control form-control-sm" placeholder="Số tầng ..." :readonly="view" :disabled="view" v-model="data.acceptance_number_floors">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex flex-column gap-2">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                                <input type="text" class="form-control form-control-sm" placeholder="Cấp công trình..." :readonly="view" :disabled="view" v-model="data.acceptance_construction_level">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-5">
                                                <div class="d-flex align-items-center h-100">
                                                    <IconFileInfo :size="24" class="d-flex text-muted bg-dark bg-opacity-10 p-1 rounded-2" stroke-width="2" />
                                                    <span class="ms-2">Thời gian hoàn thành xây dựng :</span>
                                                </div>
                                            </div>
                                            <div class="col-lg-7">
                                                <VueDatePicker class="custom-datepicker custom-datepicker-sm" v-model="data.acceptance_completion_time" placeholder="Chọn thời gian hoàn thành xây dựng" auto-apply :format="'dd/MM/yyyy'"  :enable-time-picker="false" hide-input-icon :readonly="view" :disabled="view"></VueDatePicker>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-5">
                                                <div class="d-flex align-items-center h-100">
                                                    <IconFileInfo :size="24" class="d-flex text-muted bg-dark bg-opacity-10 p-1 rounded-2" stroke-width="2" />
                                                    <span class="ms-2">Thời hạn sở hữu:</span>
                                                </div>
                                            </div>
                                            <div class="col-lg-7">
                                                <VueDatePicker class="custom-datepicker custom-datepicker-sm" v-model="data.acceptance_ownership_period" placeholder="Chọn thời hạn sở hữu" auto-apply :format="'dd/MM/yyyy'"  :enable-time-picker="false" hide-input-icon :readonly="view" :disabled="view"></VueDatePicker>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item rounded-0 border-bottom position-relative">
                                    <h2 class="accordion-header">
                                        <div class="w-100 border-0 p-3 collapsed" type="button" data-bs-toggle="collapse" :data-bs-target="'#'+slug" aria-expanded="true">
                                            <div class="d-flex">
                                                <div class="d-flex align-items-center gap-3 flex-grow-1">
                                                    <div>
                                                        <h6 class="mb-0 fw-semibold">DANH SÁCH PHÁP NGHIỆM THU & SỠ HỮU CÔNG TRÌNH
                                                        <span v-if="data.lstAcceptanceLegal">
                                                            <span class="ms-2" v-if="data.lstAcceptanceLegal.length > 0">
                                                    ...
                                                    v-if="$CheckPermission('Acceptance_Legal','is_allow_create')"
                                                    >
                                    ...
                                    <div :id="slug" class="accordion-collapse collapse" :data-bs-parent="'#'+slug+'Parent'">
                                        <div class="accordion-body border-top">
                                            <div class="table-responsive h-scrollbar" v-if="$CheckPermission('Acceptance_Legal','is_allow_access')" style="max-height:260px">
                                                <table v-if="data.lstAcceptanceLegal && data.lstAcceptanceLegal.length != 0" class="table table-sm table-striped table-fixed align-middle" style="width:160%">
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(item, index) in data.lstAcceptanceLegal" :key="index">
                                                            ...
                                                            <td class="text-capitalize">{{item.acceptance_legal_content}}</td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-1 justify-content-center">
                                                                    ...
                                                                    <div v-if="$CheckPermission('Acceptance_Legal','is_allow_edit')">
                                                                    ...
                                                                    <div v-if="$CheckPermission('Acceptance_Legal','is_allow_delete')">
...
export default {
    ...
    methods : {
        ...
        ChangeStatus(e){
            ...
            axios.post(API_USER_STORE + '/acceptance-legal/update',params,config)
            .then(async res => {
                this.Display(false)
                this.ReloadData();
        ...
        CheckStatus(){
            let TotalLegal = this.data.lstAcceptanceLegal.filter(item => (item.status_content === 2 || item.status_content === 3)).length
            TotalLegal == this.data.lstAcceptanceLegal.length ? this.status = 1 : this.status = 0
        },

        SaveLegalData(){
            const params ={
                "id": this.data.id,
                "acceptance_construction_name": this.data.acceptance_construction_name,
                "acceptance_building_area": this.data.acceptance_building_area,
                "acceptance_total_area": this.data.acceptance_total_area,
                "acceptance_number_floors": this.data.acceptance_number_floors,
                "acceptance_construction_level": this.data.acceptance_construction_level,
                "acceptance_completion_time": this.data.acceptance_completion_time,
                "acceptance_ownership_period": this.data.acceptance_ownership_period,
                "project_id": this.ProjectId,
            }
            const config = {headers: {Authorization: `Bearer ${this.authorize.token}`}};
            axios.post(API_USER_STORE + '/acceptance-legal/create-or-update-master',params,config)
            .then(async res => {
                this.ReloadData();
        ...
        DeleteLegalData(){
            ...
            const config = {headers: {Authorization: `Bearer ${this.authorize.token}`}};
            axios.post(API_USER_STORE + '/acceptance-legal/delete-master',params,config)
            .then(async res => {
                this.ReloadData();
