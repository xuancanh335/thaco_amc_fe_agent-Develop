                    ...
                    <div class="d-flex mb-3">
                        <div class="d-flex align-items-center gap-3 flex-grow-1">
                            <div class="bg-gradient-blue text-white rounded-3 p-2 bg-opacity-25 ">
                                <IconBrandDatabricks :size="22" class="d-flex" stroke-width="2" />
                            </div>
                            <div class="d-flex w-100 justify-content-between align-items-center">
                                <div>
                                    <h6 class="mb-0 fw-bold mb-1 text-gradient-blue">Pháp lý xây dựng</h6>
                                <p class="mb-0 text-muted" style="font-size:12px">Danh sách pháp lý xây dựng</p>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5">
                                                <div class="d-flex align-items-center h-100">
                                                    ...
                                                    <span class="ms-2">Tên công trình :</span>
                                                </div>
                                            </div>
                                            <div class="col-lg-7">
                                                <input type="text" class="form-control form-control-sm" placeholder="Nhập tên công trình ..." :readonly="view" :disabled="view" v-model="data.construction_project_name">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-5">
                                                <div class="d-flex align-items-center h-100">
                                                    ...
                                                    <span class="ms-2">Vị trí xây dựng :</span>
                                                </div>
                                            </div>
                                            <div class="col-lg-7">
                                                <input type="text" class="form-control form-control-sm" placeholder="Nhập vị trí xây dựng..." :readonly="view" :disabled="view" v-model="data.construction_location">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-5">
                                                <div class="d-flex align-items-center h-100">
                                                    <IconFileInfo :size="24" class="d-flex text-muted bg-dark bg-opacity-10 p-1 rounded-2" stroke-width="2" />
                                                    <span class="ms-2">Mật độ xây dựng :</span>
                                                </div>
                                            </div>
                                            <div class="col-lg-7">
                                                <input type="text" class="form-control form-control-sm" placeholder="Mật độ xây dựng..." :readonly="view" :disabled="view" v-model="data.construction_building_density">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-5">
                                                <div class="d-flex align-items-center h-100">
                                                    <IconKey :size="24" class="d-flex text-muted bg-dark bg-opacity-10 p-1 rounded-2" stroke-width="2" />
                                                    <span class="ms-2">Diện tích xây dựng :</span>
                                                </div>
                                            </div>
                                            <div class="col-lg-7">
                                                <input type="number" class="form-control form-control-sm" placeholder="Diện tích xây dựng ..." :readonly="view" :disabled="view" v-model="data.construction_building_area">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex flex-column gap-2">
                                        <div class="row">
                                            <div class="col-lg-5">
                                                <div class="d-flex align-items-center h-100">
                                                    <IconFileInfo :size="24" class="d-flex text-muted bg-dark bg-opacity-10 p-1 rounded-2" stroke-width="2" />
                                                    <span class="ms-2">Tổng diện tích sàn :</span>
                                                </div>
                                            </div>
                                            <div class="col-lg-7">
                                                <input type="number" class="form-control form-control-sm" placeholder="Tổng diện tích sàn xây dựng..." :readonly="view" :disabled="view" v-model="data.construction_total_area">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-5">
                                                <div class="d-flex align-items-center h-100">
                                                    <IconFileInfo :size="24" class="d-flex text-muted bg-dark bg-opacity-10 p-1 rounded-2" stroke-width="2" />
                                                    <span class="ms-2">Chỉ giới xây dựng :</span>
                                                </div>
                                            </div>
                                            <div class="col-lg-7">
                                                <input type="text" class="form-control form-control-sm" placeholder="Chỉ giới xây dựng..." :readonly="view" :disabled="view" v-model="data.construction_boundaries">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5">
                                                <div class="d-flex align-items-center h-100">
                                                    <IconFileInfo :size="24" class="d-flex text-muted bg-dark bg-opacity-10 p-1 rounded-2" stroke-width="2" />
                                                    <span class="ms-2">Cấp công trình :</span>
                                                </div>
                                            </div>
                                            <div class="col-lg-7">
                                                <input type="text" class="form-control form-control-sm" placeholder="Cấp công trình..." :readonly="view" :disabled="view" v-model="data.construction_project_level">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5">
                                                <div class="d-flex align-items-center h-100">
                                                    <IconFileInfo :size="24" class="d-flex text-muted bg-dark bg-opacity-10 p-1 rounded-2" stroke-width="2" />
                                                    <span class="ms-2">Kết cấu công trình :</span>
                                                </div>
                                            </div>
                                            <div class="col-lg-7">
                                                <input type="text" class="form-control form-control-sm" placeholder="Kết cấu công trình..." :readonly="view" :disabled="view" v-model="data.construction_structure">
                                            </div>
                                        </div>
                                ...
                                <div class="accordion-item rounded-0 border-bottom position-relative">
                                                ...
                                                <div class="d-flex align-items-center gap-3 flex-grow-1">
                                                    <div>
                                                        <h6 class="mb-0 fw-semibold">
                                                            DANH SÁCH PHÁP LÝ XÂY DỰNG
                                                            <span v-if="data.lstConstructionLegal">
                                                                <span class="ms-2" v-if="data.lstConstructionLegal.length > 0">
                                                    ...
                                                    <div class="position-absolute end-0 top-0 p-1 pe-2" style="margin-top:2px"
                                                    v-if="$CheckPermission('Construction_Legal','is_allow_create')"
                                                    >
                                    ...
                                    <div :id="slug" class="accordion-collapse collapse" :data-bs-parent="'#'+slug+'Parent'">
                                        <div class="accordion-body border-top">
                                            <div class="table-responsive h-scrollbar" v-if="$CheckPermission('Construction_Legal','is_allow_access')" style="max-height:260px">
                                                <table v-if="data.lstConstructionLegal && data.lstConstructionLegal.length != 0" class="table table-sm table-striped table-fixed align-middle" style="width:160%">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(item, index) in data.lstConstructionLegal" :key="index">
                                                            ...
                                                            <td class="text-capitalize">{{item.construction_legal_content}}</td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-1 justify-content-center">
                                                                    ...
                                                                    <div
                                                                    v-if="$CheckPermission('Construction_Legal','is_allow_edit')"
                                                                    >
                                                                    ...
                                                                    <div
                                                                    v-if="$CheckPermission('Construction_Legal','is_allow_delete')"
                                                                    >
...
export default {
    ...
    methods : {
        ...
        ChangeStatus(e){
            ...
            axios.post(API_USER_STORE + '/construction-legal/update',params,config)
            .then(async res => {
                this.Display(false)
                this.ReloadData();
        ...
        SaveLegalData(){
            const params = {
                "id": this.data.id,
                "construction_boundaries": this.data.construction_boundaries,
                "construction_building_area": this.data.construction_building_area,
                "construction_building_density": this.data.construction_building_density,
                "construction_location": this.data.construction_location,
                "construction_project_level": this.data.construction_project_level,
                "construction_project_name": this.data.construction_project_name,
                "construction_structure": this.data.construction_structure,
                "construction_total_area": this.data.construction_total_area,
                "project_id": this.ProjectId,
            }
            const config = {headers: {Authorization: `Bearer ${this.authorize.token}`}};
            axios.post(API_USER_STORE + '/construction-legal/create-or-update-master',params,config)
            .then(async res => {
                this.ReloadData();
        ...
        DeleteLegalData(){
            ...
            const config = {headers: {Authorization: `Bearer ${this.authorize.token}`}};
            axios.post(API_USER_STORE + '/construction-legal/delete-master',params,config)
            .then(async res => {
                this.ReloadData();
        ...
        CheckStatus(){
            let TotalLegal = this.data.lstConstructionLegal.filter(item => (item.status_content === 2 || item.status_content === 3)).length
            TotalLegal == this.data.lstConstructionLegal.length ? this.status = 1 : this.status = 0
        },
        ReloadData(){
