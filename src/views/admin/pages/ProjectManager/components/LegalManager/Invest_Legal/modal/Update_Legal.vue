        ...
        <div class="bg-white p-5 rounded-3" style="width:1000px">
            <div class="d-flex mb-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-primary mb-1">Cập nhật pháp lý đầu tư</h6>
                        <p class="mb-0 text-muted" style="font-size:12px">Cập nhật pháp lý đầu tư với dữ liệu đi kèm</p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="mb-3">
                        <label class="form-label">Tên pháp lý đầu tư (<span class="text-danger">*</span>)</label>
                        <textarea type="text" class="form-control" placeholder="Nhập tên pháp lý đầu tư ..." v-model="data.invest_legal_content" rows='1'></textarea>
                    </div>
                    <div class="mb-3">
    ...
    methods : {
        ...
        async UpdateLegal(){            
            try {
                ...
                axios.post(apiProject + '/invest-legal/update',params,config)
                .then(async res => {
                    this.Display(false)
        ...
        async GetDataLegal(){            
            try {
                ...
                const config = {headers: {Authorization: `Bearer ${authorize.token}`}};
                axios.post(apiProject + '/invest-legal/get-by-id',params,config)
                .then(async res => {
                    this.GetStatus()
        ...
        async Display(value,data){
            ...
            if(value){
                this.id = await data
                this.$refs.FileManager._Init({id:data,type:'TYPE_INVEST_LEGAL'});
