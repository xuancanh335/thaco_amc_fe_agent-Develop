            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <textarea type="text" class="form-control" placeholder="Nhập tên quyền ..." v-model="data.land_legal_content" rows="1"></textarea>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Số sổ - Quyền sử dụng đât (<span class="text-danger">*</span>)</label>
                        <input type="text" class="form-control" placeholder="Nhập tên quyền ..." v-model="data.land_legal_owner">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Nhập tên quyền ..." v-model="data.description">
                    </div>
                    <div class="mb-3">
    ...
    methods : {
        ...
        async UpdateLegal(){            
            try {
                ...
                axios.post(apiProject + '/land-legal/update',params,config)
                .then(async res => {
                    this.Display(false)
        ...
        async GetDataLegal(){            
            try {
                ...
                const config = {headers: {Authorization: `Bearer ${authorize.token}`}};
                axios.post(apiProject + '/land-legal/get-by-id',params,config)
                .then(async res => {
        ...
        async Display(value,data){
            ...
            if(value){
                ...
                this.$refs.FileManager._Init({id:data,type:'TYPE_LAND_LEGAL'});
            }
        }
    }
}
