            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Nhập giá trị đầu tư ..." v-model="data.investment_value" v-number="number">
                    </div>
                    <div class="mb-3">
    ...
    methods : {
        ...
        async UpdateLegal(){      
            try {
                ...
                params.tenant_id = this.authorize.tenant_id
                ...
                axios.post(PATH_API_DATA + '/construction-payment/update',params,config)
                .then(async res => {
        ...
        async GetDataLegal(){            
            try {
                ...
                const config = {headers: {Authorization: `Bearer ${this.authorize.token}`}};
                axios.post(PATH_API_DATA + '/construction-payment/get-by-id',params,config)
                .then(async res => {
        ...
        async _Init(value){
            ...
            if(this.init){
                await this.$refs.FileManager._Init({id:this.init.id,type:'TYPE_CONSTRUCTION_PAYMENT'});
