                    ...
                    <div class="d-flex mb-3">
                        <div class="d-flex align-items-center gap-3 flex-grow-1">
                            <div class="bg-gradient-blue text-white rounded-3 p-2 bg-opacity-25 ">
                                <IconTimeline :size="22" class="d-flex" stroke-width="2" />
                            </div>
                            <div>
                                <h6 class="mb-0 fw-bold mb-1 text-gradient-blue">Tiến độ xây dựng 
                                ...
                                <p class="mb-0 text-muted" style="font-size:12px">Quản lý tiến độ xây dựng</p>
                            </div>
                        </div>
                        <div class="position-absolute end-0 top-0 p-3" style="margin-top:2px"
                        v-if="$CheckPermission('Construction_Progress','is_allow_create')"
                        >
                                    ...
                                    <h2 class="accordion-header">
                                        <div class="w-100 border-0 p-3 accordion-button collapsed" type="button" data-bs-toggle="collapse" :data-bs-target="'#'+slug" aria-expanded="true">
                                            <div class="d-flex">
                                                <div class="d-flex align-items-center gap-3 flex-grow-1">
                                                    <div>
                                                        <h6 class="mb-0 fw-semibold">DANH SÁCH TIẾN ĐỘ XÂY DỰNG</h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <table v-if="data && data.length != 0" class="table table-sm table-striped table-fixed align-middle" style="width:160%">
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(item, index) in data" :key="index">
                                                            ...
                                                            <td class="text-capitalize">{{item.construction_progress_content}}</td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-1 justify-content-center">
                                                                    <div v-if="$CheckPermission('Construction_Progress','is_allow_edit')">
                                                                    ...
                                                                    <div v-if="$CheckPermission('Construction_Progress','is_allow_delete')">
...
export default {
    ...
    methods : {
        ...
        ChangeStatus(e){
            ...
            axios.post(API_USER_STORE + '/construction-progress/update',params,config)
            .then(async res => {
                this.Display(false)
                this.ReloadData();
