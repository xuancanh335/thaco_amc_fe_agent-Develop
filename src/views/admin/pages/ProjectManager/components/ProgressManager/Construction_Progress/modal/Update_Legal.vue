            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <textarea type="text" class="form-control" placeholder="Nhập tên tiến độ xây dựng ..." v-model="data.construction_progress_content" rows="1"></textarea>
                    </div>
                    <div class="mb-3">
...
export default {
    ...
    GetStatus(){
        ...
        async Display(value,data){
            ...
            this.id = await data
            this.$refs.FileManager._Init({id:data,type:'TYPE_CONSTRUCTION_PROGRESS'});
