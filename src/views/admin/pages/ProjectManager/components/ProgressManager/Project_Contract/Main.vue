                    ...
                    <div class="d-flex mb-3">
                        <div class="d-flex align-items-center gap-3 flex-grow-1">
                            ...
                            <div>
                                ...
                                <p class="mb-0 text-muted" style="font-size:12px">Quản lý hợp đồng và hồ sơ</p>
                            </div>
                        </div>
                        <div class="position-absolute end-0 top-0 p-3" style="margin-top:2px"
                        v-if="$CheckPermission('Project_Contract','is_allow_create')"
                        >
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex flex-column gap-2">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control form-control-sm" placeholder="Nhập mã dự án ..." :readonly="view" :disabled="view">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control form-control-sm" placeholder="Nhập tên dự án..." :readonly="view" :disabled="view">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control form-control-sm" placeholder="Chưa có dữ liệu..." :readonly="view" :disabled="view">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item rounded-0 border-bottom position-relative">
                                    <h2 class="accordion-header">
                                        <div class="w-100 border-0 p-3 accordion-button collapsed" type="button" data-bs-toggle="collapse" :data-bs-target="'#'+slug" aria-expanded="true">
                                            <div class="d-flex">
                                                <div class="d-flex align-items-center gap-3 flex-grow-1">
                                                    <div>
                                                        <h6 class="mb-0 fw-semibold">DANH SÁCH HỢP ĐỒNG & HỒ SƠ</h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div :id="slug" class="accordion-collapse collapsed" :data-bs-parent="'#'+slug+'Parent'">
                                        <div class="accordion-body border-top p-0">
                                            <div class="table-responsive h-scrollbar" v-if="$CheckPermission('Project_Contract','is_allow_access')" style="min-height:250px;max-height:250px">
                                                <table v-if="data && data.length != 0" class="table table-sm table-striped table-fixed align-middle" style="width:205%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="200" class="py-2 text-center">Mã hợp đồng</th>
                                                            ...
                                                            <th width="200" class="text-capitalize py-2 text-center">Mã hợp đồng bravo</th>
                                                            <th width="200" class="text-capitalize py-2 text-center">Ngày tạo</th>
                                                            <th width="200" class="text-capitalize py-2 text-center">Ngày dự kiến hoàn thành</th>
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(item, index) in data" :key="index">
                                                            ...
                                                            <td class="text-center">
                                                                <span>{{item.bravo_contract_id}}</span>
                                                            </td>
                                                            <td class="text-center">
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-1 justify-content-center">
                                                                    ...
                                                                    <div v-if="$CheckPermission('Project_Contract','is_allow_edit')">
                                                                    ...
                                                                    <div v-if="$CheckPermission('Project_Contract','is_allow_edit')">
                                                                        <button v-if="!view" @click="$refs.Update_Modal._Init({bravo_project_code : bravo_project_code, id : item.id})" type="button" class="btn btn-info bg-gradient btn-sm p-1">                                                                            
                                                                            <IconPencil :size="16" class="d-flex text-white" stroke-width="2" />
                                                                        </button>
                                                                    </div>

                                                                    <div v-if="$CheckPermission('Project_Contract','is_allow_delete')">
...
export default {
    ...
    methods : {
        ...
        ChangeStatus(e){
            ...
            axios.post(API_USER_STORE + '/project-contract/update',params,config)
            .then(async res => {
                this.Display(false)
                this.ReloadData();
