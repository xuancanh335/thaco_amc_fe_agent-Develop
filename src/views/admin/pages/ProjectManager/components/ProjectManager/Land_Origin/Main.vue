                    ...
                    <div class="d-flex">
                        <div class="d-flex align-items-center gap-3 flex-grow-1">
                            <div class="bg-primary rounded-3 p-2 text-white">
                                <IconArrowFork :size="22" class="d-flex" stroke-width="2" />
                            </div>
                            <div>
                                <h6 class="mb-0 fw-bold text-primary mb-1">Nguồn gốc đất</h6>
                                <p class="mb-0 text-muted" style="font-size:12px">Danh sách nguồn gốc đất</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div :id="slug" class="accordion-collapse collapse " :data-bs-parent="'#'+slug+'Parent'">
                <div class="accordion-body border-top">
                    <div class="table-responsive h-scrollbar">
                        <table v-if="data && data.length != 0" class="table table-sm table-striped table-fixed align-middle" style="width:150%">
                            <thead>
                                <tr>
                                    <th style="max-width:50px;min-width:50px" class="text-center py-2">#</th>
                                    <th class="py-2">Nội dung pháp lý</th>
                                    <th class="text-capitalize py-2">Diễn giải</th>
                                    <th width="15%" class="text-capitalize py-2 text-center">Ngày tạo</th>
                                    <th width="10%" class="text-capitalize py-2 text-center">Trạng thái</th>
                                    <th width="10%" class="text-capitalize py-2 text-center">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in data" :key="index">
                                    ...
                                    <td class="text-capitalize">{{item.land_origin_content}}</td>
                                    <td>
...
export default {
    ...
    components: {
        ...Icons,
        Create_Legal,Delete_Legal,Update_Legal,File_Legal
    },
    methods : {
        ReloadData(){
