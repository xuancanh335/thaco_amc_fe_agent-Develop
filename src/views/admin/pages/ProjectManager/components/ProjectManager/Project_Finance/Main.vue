<template lang="">
    ...
    <div class="accordion" :id="slug+'Parent'">
        <div class="accordion-item mb-3 rounded-0 border-bottom position-relative">
            ...
            v-if="$CheckPermission('Project_Finance','is_allow_create')"
            >
                ...
                <div class="w-100 border-0 p-3" type="button" data-bs-toggle="collapse" :data-bs-target="'#'+slug" aria-expanded="true">
                    ...
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                        <div class="bg-gradient-blue text-white rounded-3 p-2 bg-opacity-25 ">
                            <IconCoin :size="22" class="d-flex" stroke-width="2" />
                        </div>
                        <div>
                            <h6 class="mb-0 fw-bold mb-1 text-gradient-blue">Tài chính dự án
                            ...
                            <p class="mb-0 text-muted" style="font-size:12px">Danh sách tài chính dự án</p>
                        </div>
                    </div>
                </div>
            </h2>
            <div :id="slug" class="accordion-collapse collapse " :data-bs-parent="'#'+slug+'Parent'">
                <div class="accordion-body border-top">
                    ...
                    v-if="$CheckPermission('Project_Finance','is_allow_access')"
                    >
                                ...
                                <tr class="bg-secondary bg-opacity-5" v-for="(item, index) in data" :key="index">
                                    ...
                                    <td>
                                        <div class="d-flex gap-1 justify-content-end">
                                            ...
                                            <div
                                            v-if="$CheckPermission('Project_Finance','is_allow_edit')"
                                            >
                                            ...
                                            <div
                                            v-if="$CheckPermission('Project_Finance','is_allow_delete')"
                                            >
...
import {IconX, IconPlus, IconCalendar, IconDotsVertical,IconEye,IconBrowserPlus,IconDatabaseEdit,IconPencil, IconPaperclip, IconCoin } from '@tabler/icons-vue';
...
export default {
    ...
    components: {
        IconX, IconPlus, IconCalendar, IconDotsVertical,IconEye,IconBrowserPlus,IconDatabaseEdit,IconPencil,IconPaperclip,IconCoin,
