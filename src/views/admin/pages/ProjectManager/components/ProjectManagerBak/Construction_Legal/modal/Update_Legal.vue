        ...
        <div class="bg-white p-5 rounded-3" style="width:500px">
            ...
            <div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập tên pháp lý xây dựng ..." v-model="data.construction_legal_content">
                </div>
                <div class="mb-3">
