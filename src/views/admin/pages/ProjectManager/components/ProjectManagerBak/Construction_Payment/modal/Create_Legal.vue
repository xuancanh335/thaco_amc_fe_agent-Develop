        ...
        <div class="bg-white p-5 rounded-3" style="width:500px">
            ...
            <div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập giá trị đầu tư ..." v-model.lazy="data.investment_value" v-number="number">
                </div>
                <div class="mb-3">
    ...
    methods : {
        ...
        async CreateLegal(){ 
            try {
                ...
                axios.post(apiProject + '/construction-payment/create',params,config)
                .then(async res => {
                    this.Display(false)
