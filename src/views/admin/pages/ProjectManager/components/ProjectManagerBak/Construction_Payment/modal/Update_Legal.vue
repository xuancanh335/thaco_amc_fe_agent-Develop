        ...
        <div class="bg-white p-5 rounded-3" style="width:500px">
            <div class="d-flex mb-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-primary mb-1">Cập nhật tiến độ thanh toán</h6>
                        <p class="mb-0 text-muted" style="font-size:12px">Cập nhật tiến độ thanh toán với dữ liệu đi kèm</p>
                    </div>
                </div>
            ...
            <div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập tên tiến độ thanh toán ..." v-model="data.construction_payment_content">
                </div>
                <div class="mb-3">
                    <label class="form-label">Giá trị đầu tư (<span class="text-danger">*</span>)</label>
                    <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập giá trị đầu tư ..." v-model="data.investment_value" v-number="number">
                </div>
                <div class="mb-3">
    ...
    GetStatus(){
        ...
        async UpdateLegal(){            
            try {
                ...
                axios.post(apiProject + '/construction-payment/update',params,config)
                .then(async res => {
                    this.Display(false)
        ...
        async GetDataLegal(){            
            try {
                ...
                const config = {headers: {Authorization: `Bearer ${authorize.token}`}};
                axios.post(apiProject + '/construction-payment/get-by-id',params,config)
                .then(async res => {
