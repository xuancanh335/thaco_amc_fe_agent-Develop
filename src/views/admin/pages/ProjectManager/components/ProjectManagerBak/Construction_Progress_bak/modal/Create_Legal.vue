        ...
        <div class="bg-white p-5 rounded-3" style="width:500px">
            <div class="d-flex mb-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-primary mb-1">Tạo tiến độ xây dựng</h6>
                        <p class="mb-0 text-muted" style="font-size:12px">Tạo tiến độ xây dựng với dữ liệu đi kèm</p>
                    </div>
                </div>
    ...
    methods : {
        async CreateLegal(){ 
            try {
                ...
                axios.post(apiProject + '/construction-progress/create',params,config)
                .then(async res => {
                    this.Display(false)
