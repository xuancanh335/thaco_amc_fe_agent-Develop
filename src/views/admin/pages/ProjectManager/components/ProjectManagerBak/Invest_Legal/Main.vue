                ...
                <div class="w-100 border-0 p-3" type="button" data-bs-toggle="collapse" :data-bs-target="'#'+slug" aria-expanded="true">
                    <div class="d-flex">
                        <div class="d-flex align-items-center gap-3 flex-grow-1">
                            <div class="bg-gradient-blue rounded-3 p-2 bg-opacity-25 text-white">
                                <IconBusinessplan :size="22" class="d-flex" stroke-width="2" />
                            </div>
                            <div>
                                <h6 class="mb-0 fw-bold mb-1 text-gradient-blue">Pháp lý đầu tư 
                        ...
                        <!-- <div class="d-flex align-items-center gap-3 flex-grow-1">
                            ...
                            <div>
                                <h6 class="mb-0 fw-bold text-primary mb-1">Pháp lý đầu tư</h6>
                                <p class="mb-0 text-muted" style="font-size:12px">Danh sách pháp lý đầu tư</p>
                            </div>
                        </div> -->
                    </div>
