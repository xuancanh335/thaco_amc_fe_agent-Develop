        ...
        <div class="bg-white p-5 rounded-3" style="width:500px">
            <div class="d-flex mb-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-primary mb-1">Tạo nguồn gốc đất</h6>
                        <p class="mb-0 text-muted" style="font-size:12px">Tạo nguồn gốc đất với dữ liệu đi kèm</p>
                    </div>
                </div>
            ...
            <div>
                <div class="mb-3">
                    <label class="form-label">Tên nguồn gốc đất (<span class="text-danger">*</span>)</label>
                    <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập tên nguồn gốc đất ..." v-model="data.land_origin_content">
                </div>
                <div class="mb-3">
    ...
    methods : {
        async CreateLegal(){ 
            try {
                ...
                axios.post(apiProject + '/land-origin/create',params,config)
                .then(async res => {
                    this.Display(false)
