        ...
        <div class="bg-white p-5 rounded-3" style="width:500px">
            <div class="d-flex mb-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-primary mb-1">Tạo pháp lý quy hoạch</h6>
                        <p class="mb-0 text-muted" style="font-size:12px">Tạo pháp lý quy hoạch với dữ liệu đi kèm</p>
                    </div>
                </div>
            ...
            <div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập tên pháp lý quy hoạch ..." v-model="data.planning_legal_content">
                </div>
                <div class="mb-3">
    ...
    methods : {
        ...
        async CreateLegal(){
            try {
                ...
                axios.post(apiProject + '/planning-legal/create',params,config)
                .then(async res => {
                    this.Display(false)
