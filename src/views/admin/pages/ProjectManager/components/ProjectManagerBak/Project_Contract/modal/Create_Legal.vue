        ...
        <div class="bg-white p-5 rounded-3" style="width:500px">
            ...
            <div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập tên hợp đồng, hồ sơ ..." v-model="data.contract_content">
                </div>
                <div class="mb-3">
                    <label class="form-label">Giá trị HĐ (<span class="text-danger">*</span>)</label>
                    <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập giá trị hợp đồng ..." v-model.lazy="data.contract_value" v-number="number">
                </div>
                <div class="mb-3">
    ...
    methods : {
        ...
        async CreateLegal(){ 
            try {
                ...
                axios.post(apiProject + '/project-contract/create',params,config)
                .then(async res => {
                    this.Display(false)
