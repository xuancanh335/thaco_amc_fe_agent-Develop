        ...
        <div class="bg-white p-5 rounded-3" style="width:500px">
            ...
            <div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập tên nguồn gốc đất ..." v-model="data.contract_content">
                </div>
                <div class="mb-3">
                    <label class="form-label">Gia trị HĐ (<span class="text-danger">*</span>)</label>
                    <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập giá trị hợp đồng ..." v-model="data.contract_value" v-number="number">
                </div>
                <div class="mb-3">
