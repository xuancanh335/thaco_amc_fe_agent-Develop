<template lang="">
    ...
    <div class="accordion" :id="slug+'Parent'">
        <div class="accordion-item mb-3 rounded-0 border-bottom position-relative">
            ...
            v-if="$CheckPermission('Proposal_Approve_Project','is_allow_create')"
            >
                ...
                <div class="w-100 border-0 p-3" type="button" data-bs-toggle="collapse" :data-bs-target="'#'+slug" aria-expanded="true">
                    <div class="d-flex">
                        <div class="d-flex align-items-center gap-3 flex-grow-1">
                            ...
                            <div>
                                <h6 class="mb-0 fw-bold text-gradient-blue mb-1">Phê duyệt dự án đầu tư</h6>
                                <p class="mb-0 text-muted" style="font-size:12px">Danh sách quyết định phê duyệt dự án đầu tư</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div :id="slug" class="accordion-collapse collapse " :data-bs-parent="'#'+slug+'Parent'">
                ...
                v-if="$CheckPermission('Proposal_Approve_Project','is_allow_access')"
                >
                    <table v-if="data && data.length != 0" class="table table-xl table table-striped align-middle">
                        <thead>
                            <tr>
                                <th width="5%" class="text-center py-2">#</th>
                                <th class="py-2">Nội dụng</th>
                            ...
                            <tr v-for="(item, index) in data" :key="index">
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        <div v-if="$CheckPermission('Proposal_Approve_Project','is_allow_edit')">
                                        ...
                                        <div v-if="$CheckPermission('Proposal_Approve_Project','is_allow_delete')">
