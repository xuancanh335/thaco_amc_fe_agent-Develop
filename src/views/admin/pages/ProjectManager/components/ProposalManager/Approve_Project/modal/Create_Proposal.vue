        ...
        <div class="bg-white p-5 rounded-3" style="width:1000px">
            <div class="d-flex mb-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-gradient-blue mb-1">Tạo phê duyệt dự án đầu tư</h6>
                        <p class="mb-0 text-muted" style="font-size:12px">Tạo quyết định phê duyệt dự án đầu tư</p>
                    </div>
                </div>
    ...
    methods : {
        async CreateLegal(){            
            try {
                ...
                axios.post(apiProject + '/proposal-approve-project/create',params,config)
                .then(async res => {
                    await this.$refs.FileManager.UpdateLegal({id:res.data.data.id,type:'TYPE_APPROVE_PROJECT'})
                    this.Display(false)
