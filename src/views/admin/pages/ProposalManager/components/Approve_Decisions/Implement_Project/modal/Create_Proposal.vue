        ...
        <div class="bg-white p-5 rounded-3" style="width:500px">
            <div class="d-flex mb-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-primary mb-1">Tạo chủ trương thực hiện dự án</h6>
                        <p class="mb-0 text-muted" style="font-size:12px">Tạo chủ trương thực hiện dự án với dữ liệu đi kèm</p>
                    </div>
                </div>
            ...
            <div> 
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập báo cáo thị trường ..." v-model="data.content">
                </div>

                <div class="mb-3">
                    <label class="form-label">Giá trị (<span class="text-danger">*</span>)</label>
                    <input type="number" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập sơ bộ tổng mức đầu tư ..." v-model="data.content_value">
                </div>
    ...
    methods : {
        async CreateLegal(){            
            try {
                ...
                axios.post(apiProject + '/proposal-implement-project/create',params,config)
                .then(async res => {
                    this.Display(false)
