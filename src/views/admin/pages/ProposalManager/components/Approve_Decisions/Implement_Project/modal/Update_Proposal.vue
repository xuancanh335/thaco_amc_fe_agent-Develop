        ...
        <div class="bg-white p-5 rounded-3" style="width:500px">
            <div class="d-flex mb-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-primary mb-1">Cập nhật chủ trương thực hiện dự án</h6>
                        <p class="mb-0 text-muted" style="font-size:12px">Chủ trương thực hiện dự án với dữ liệu đi kèm</p>
                    </div>
                </div>
            ...
            <div>               
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập diễn giải ..." v-model="data.content_value">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm rounded-0 border-0 border-bottom shadow-none" placeholder="Nhập ghi chú ..." v-model="data.description">
                </div>                 
            </div>
            <div class="d-flex justify-content-end gap-2 mt-4">
                <button type="button" class="btn bg-secondary bg-opacity-25" @click="Display(false)">Hủy bỏ</button>
                <button type="button" class="btn btn-success bg-gradient" @click="UpdateLegal">Cập nhật thông tin</button>
            </div>
        </div>
    </div>
</template>
    ...
    methods : {
        async UpdateLegal(){            
            try {
                ...
                axios.post(apiProject + '/proposal-implement-project/update',params,config)
                .then(async res => {
                    this.Display(false)
        ...
        async GetDataLegal(){            
            try {
                ...
                const config = {headers: {Authorization: `Bearer ${authorize.token}`}};
                axios.post(apiProject + '/proposal-implement-project/get-by-id',params,config)
                .then(async res => {
