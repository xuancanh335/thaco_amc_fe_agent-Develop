<template lang="">
    <div class="modal fade scale-in-center" id="Modal_DeleteBank" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body p-4">
                    <div class="d-flex gap-3 mb-4">
                        ...
                        <div class="flex-grow-1">
                            <h5>Xóa ngân hàng</h5>
                            <p class="mb-0 text-muted">Bạn sẽ mất tất cả các dữ liệu liên quan đến ngân hàng, bạn có chắc chắn muốn xóa !</p>
                        </div>
                    </div>
...
export default {
    ...
    mounted(){
        var modal = document.getElementById('Modal_DeleteBank')
        var main = this
    ...
    methods : {
        async DeleteData(){
            try {
                ...
                await axios.post(PATH_API_USER + '/bank/delete',params,config)
                .then(async res => {
                    var Modal_DeleteBank = bootstrap.Modal.getOrCreateInstance(document.getElementById('Modal_DeleteBank'));
                    this.$emit('RefreshData');
                    Modal_DeleteBank.hide();
