<template lang="">
    <div class="modal fade scale-in-center" id="Modal_DeleteCustomer" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body p-4">
                    <div class="d-flex gap-3 mb-4">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="mb-0 text-muted">Bạn sẽ mất tất cả các dữ liệu liên quan đến khách hàng, bạn có chắc chắn muốn xóa !</p>
                        </div>
                    </div>
...
export default {
    ...
    mounted(){
        var modal = document.getElementById('Modal_DeleteCustomer')
        var main = this
    ...
    methods : {
        async DeleteData(){
            try {
                ...
                await axios.post(PATH_API_USER + '/customer/delete',params,config)
                .then(async res => {
                    var Modal_DeleteCustomer = bootstrap.Modal.getOrCreateInstance(document.getElementById('Modal_DeleteCustomer'));
                    this.$emit('RefreshData');
                    Modal_DeleteCustomer.hide();
