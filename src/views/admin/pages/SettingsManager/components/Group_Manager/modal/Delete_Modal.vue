<template lang="">
    <div class="modal fade scale-in-center" id="Modal_DeleteGroup" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body p-4">
                    <div class="d-flex gap-3 mb-4">
                        ...
                        <div class="flex-grow-1">
                            <h5>Xóa tập đoàn</h5>
                            <p class="mb-0 text-muted">Bạn sẽ mất tất cả các dữ liệu liên quan đến tập đoàn, bạn có chắc chắn muốn xóa !</p>
                        </div>
                    </div>
...
export default {
    ...
    mounted(){
        var modal = document.getElementById('Modal_DeleteGroup')
        var main = this
    ...
    methods : {
        async DeleteData(){
            try {
                ...
                await axios.post(PATH_API_USER + '/group/delete',params,config)
                .then(async res => {
                    var Modal_DeleteGroup = bootstrap.Modal.getOrCreateInstance(document.getElementById('Modal_DeleteGroup'));
                    this.$emit('RefreshData');
                    Modal_DeleteGroup.hide();
