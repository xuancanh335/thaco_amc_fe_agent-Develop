<template lang="">
    <div class="tab-pane h-100 fade show" id="account-item-sync-pane" role="tabpanel">
                ...
                <table class="table table-striped align-middle">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" width="4%">Mã code tài khoản</th>
                            <th scope="col" width="15%">Tên tài khoản</th>
                            <th scope="col" width="10%">Mã tài khoản cha</th>
...
export default {
    ...
    methods : {
        ...
        GetDataSync(){
            ...
            axios.post(PATH_API_WEBHOOK + '/account-item/get-all',params,config)
            .then(res => {
        ...
        SyncData(data){
            ...
            let config = {headers: {Authorization: `Bearer ${this.authorize.token}`}}
            axios.post(PATH_API_WEBHOOK + '/account-item/sync-data-bravo',params,config)
            .then(res => {
                setTimeout(() => {
