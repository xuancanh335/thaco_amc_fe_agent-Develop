<template lang="">
    <div class="tab-pane h-100 fade show" id="asset-group-sync-pane" role="tabpanel">
                ...
                <table class="table table-striped align-middle">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" width="10%">Mã khoản mục phí</th>
                            <th scope="col" width="20%">Tên khoản mục phí</th>
                            <th scope="col" width="15%">Mã khoản mục phí cha</th>
...
export default {
    ...
    methods : {
        ...
        GetDataSync(){
            ...
            axios.post(PATH_API_WEBHOOK + '/asset-group/get-all',params,config)
            .then(res => {
        ...
        SyncData(data){
            ...
            let config = {headers: {Authorization: `Bearer ${this.authorize.token}`}}
            axios.post(PATH_API_WEBHOOK + '/asset-group/sync-data-bravo',params,config)
            .then(res => {
                setTimeout(() => {
