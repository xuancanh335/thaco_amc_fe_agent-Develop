<template lang="">
    <div class="modal fade scale-in-center" id="Modal_DeleteAssetsItemSync" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
export default {
    ...
    mounted(){
        modal = new bootstrap.Modal('#Modal_DeleteAssetsItemSync');
    },
    methods : {
        async _Init(value){
        ...
        async DeleteData(){
            try {
                ...
                await axios.post(PATH_API_WEBHOOK + '/asset-item/delete',params,config)
                .then(async res => {
