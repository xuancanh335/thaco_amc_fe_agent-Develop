<template lang="">
    <div class="tab-pane h-100 fade show" id="customer-sync-pane" role="tabpanel">
                ...
                <table class="table table-striped align-middle">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" width="7%">Mã đối tượng</th>
                            <th scope="col" width="15%">Tên đối tượng</th>
...
export default {
    ...
    methods : {
        ...
        SyncData(data){
            ...
            let config = {headers: {Authorization: `Bearer ${this.authorize.token}`}}
            axios.post(PATH_API_WEBHOOK + '/customer-bravo/sync-data-bravo',params,config)
            .then(res => {
                setTimeout(() => {
