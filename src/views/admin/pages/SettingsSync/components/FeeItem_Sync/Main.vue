<template lang="">
    <div class="tab-pane h-100 fade show" id="fee-item-sync-pane" role="tabpanel">
...
export default {
    ...
    methods : {
        ...
        GetDataSync(){
            ...
            axios.post(PATH_API_WEBHOOK + '/fee-item/get-all',params,config)
            .then(res => {
        ...
        SyncData(data){
            ...
            let config = {headers: {Authorization: `Bearer ${this.authorize.token}`}}
            axios.post(PATH_API_WEBHOOK + '/fee-item/sync-data-bravo',params,config)
            .then(res => {
                setTimeout(() => {
