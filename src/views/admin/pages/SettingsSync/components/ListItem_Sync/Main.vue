<template lang="">
    <div class="tab-pane h-100 fade show" id="list-item-sync-pane" role="tabpanel">
                ...
                <table class="table table-striped align-middle">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" width="10%">Mã code hạng mục</th>
                            <th scope="col" width="20%">Mã tên hạng mục</th>
                            <th scope="col" width="15%">Mã hạng mục cha</th>
...
export default {
    ...
    methods : {
        ...
        GetDataSync(){
            ...
            axios.post(PATH_API_WEBHOOK + '/list-item/get-all',params,config)
            .then(res => {
        ...
        SyncData(data){
            ...
            let config = {headers: {Authorization: `Bearer ${this.authorize.token}`}}
            axios.post(PATH_API_WEBHOOK + '/list-item/sync-data-bravo',params,config)
            .then(res => {
                setTimeout(() => {
