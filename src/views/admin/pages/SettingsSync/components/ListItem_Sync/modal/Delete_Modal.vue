<template lang="">
    <div class="modal fade scale-in-center" id="Modal_DeleteListItemSync" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
export default {
    ...
    mounted(){
        modal = new bootstrap.Modal('#Modal_DeleteListItemSync');
    },
    methods : {
        async _Init(value){
        ...
        async DeleteData(){
            try {
                ...
                await axios.post(PATH_API_WEBHOOK + '/list-item/delete',params,config)
                .then(async res => {
